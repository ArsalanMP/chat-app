...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Container = function (_Component) {
		...
		_createClass(Container, [{
			key: 'setStateUpdate',
			value: function setStateUpdate(update) {
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Profile2.default, { name: this.state.name, setStateUpdate: this.setStateUpdate.bind(this) }),
					_react2.default.createElement(_Chat2.default, { name: this.state.name })
				);
			}
		}]);
		...
		_createClass(Profile, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'form',
						{ onSubmit: this.onSetName.bind(this) },
						_react2.default.createElement('input', { placeholder: 'enter your name', ref: 'username' }),
						_react2.default.createElement(
							'button',
							null,
							'OK'
	...
	var Chat = function (_Component) {
		...
		_createClass(Chat, [{
			...
			value: function componentDidMount() {
				...
				this.socket = _socket2.default.connect('http://localhost:4000');
			...
			key: 'render',
			value: function render() {
				var elems = this.state.messages.map(function (messages, index) {
					return _react2.default.createElement(
						'div',
						{ key: index },
						messages
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { placeholder: 'enter your message', ref: 'message' }),
						_react2.default.createElement(
							'button',
							null,
							'Send'
